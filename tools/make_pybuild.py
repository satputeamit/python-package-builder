...
def add_pybind(code: str)->str:
    ...
    system = SystemMessage(content="You are a code converter. Add pybind header and other required code to C++ code and also use defined function name as module name properly and dont remove any important imports, will use to to create .pyd or .so file. Only output the converted C++ code. Do not explain or use markdown.")
